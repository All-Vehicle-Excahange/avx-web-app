    ...
    >
      ...
      {(!readOnly || logo || !readOnly || bannerPreview) && (
        <motion.div
          ...
          className="bg-transparent sm:bg-white/2 sm:backdrop-blur-md border-0 sm:border border-white/5 rounded-2xl px-0 py-4 sm:p-6 shadow-none sm:shadow-2xl sm:hover:border-white/8 transition-all duration-300 relative z-10"
        >
          <div>
