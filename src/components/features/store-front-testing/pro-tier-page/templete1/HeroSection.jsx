...
export default function FullPage() {
  ...
  const data = {
    whyBuyHeroTitle: "Why Choose Reecomm",
    whyBuyHeroDescription:
      "Buyers trust Reecomm for transparent communication, reliable vehicle options, and a smooth buying experience.",
