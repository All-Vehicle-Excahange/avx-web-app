      ...
      <div className="grid grid-cols-2 gap-6 px-5 py-4 text-[13px] leading-7">
        ...
        <div>
          ...
          <ul className="space-y-1 text-primary/70">
            ...
            <li className="hover:text-third cursor-pointer">Your Wish List</li>
            <li className="hover:text-third cursor-pointer">Recommendations</li>
            <li className="hover:text-third cursor-pointer">
              Prime Membership
            </li>
            ...
            <li className="hover:text-third cursor-pointer">Seller Account</li>
            <li className="hover:text-third cursor-pointer">Manage Devices</li>
            <li className="hover:text-third cursor-pointer">
