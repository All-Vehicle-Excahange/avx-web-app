      ...
      <div className="w-full 3xl:max-w-screen-2xl mx-auto   overflow-visible flex flex-col md:flex-row relative h-[300px]">
        ...
        <div className="flex-1 p-6 md:p-8 md:mb-30 flex flex-col justify-center z-10 relative">
          <h2 className="text-2xl max-w-2xl xl:max-w-3xl  md:text-4xl font-bold text-primary mb-4 leading-tight">
            Chat. Track. Manage. Everything happens in the app.
          </h2>

          <p className="text-primary text-lg mb-8 max-w-lg">
            Connect with sellers, track your inspection report, and manage your
            listings — all in one place on your phone.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button
              type="button"
              className="px-6 py-2 flex items-center justify-center bg-secondary text-primary hover:bg-primary hover:text-secondary transition-all duration-300 rounded-lg cursor-pointer"
            >
              <div className="mr-3">
            ...
            >
              ...
              <div className="text-left">
                <div className="text-[10px] font-bold">Download on the</div>
                <div className="text-lg font-semibold leading-none">
                  App Store
                </div>
              </div>
