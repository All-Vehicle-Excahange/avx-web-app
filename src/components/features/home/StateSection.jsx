    ...
    <section className="w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 h-auto lg:h-[400px]">
        ...
        <div className="flex flex-col gap-4 h-full">
          {/* Partners Card */}
          <div className="bg-secondary border border-third/40 rounded-2xl p-4 flex items-center justify-between shadow-md shadow-third/50">
            {/* Avatars */}
          ...
          {/* Vehicles Listed */}
          <div className="bg-primary border border-third/40 rounded-2xl p-6 shadow-md shadow-third/50 flex-1 flex flex-col justify-between min-h-40">
        ...
        <div className="flex flex-col gap-4 h-full">
          {/* Revenue Card */}
          <div className="bg-primary shadow-md shadow-third/50 border border-third/40 rounded-2xl p-6 flex-1 flex flex-col justify-between min-h-40">
            ...
            <div>
              ...
              <div className="text-secondary text-sm">Revenue generated</div>
            </div>
          </div>

          {/* Available Card */}
          <div className="bg-secondary border border-third/40 rounded-2xl p-4 flex items-center gap-3 shadow-md shadow-third/50 h-16">
        ...
        <div className="shadow-md shadow-third/50 p-6 relative overflow-hidden flex flex-col justify-between min-h-[250px] rounded-2xl">
          ...
          <div className="absolute bottom-0 right-0 p-4 md:p-2 lg:p-4  z-10">
            <div className="bg-primary shadow-md shadow-third text-secondary font-bold rounded-full w-18 h-18 md:w-22 md:h-22 lg:h-30 lg:w-30 flex items-center justify-center text-2xl">
              999+
            </div>
          </div>
        ...
        {/* Column 4 — Trusted By */}
        <div className="bg-primary shadow-md shadow-third/50 rounded-2xl p-6 relative overflow-hidden flex flex-col justify-between min-h-[250px]">
          <p className="text-secondary text-sm leading-relaxed max-w-[80%] relative z-10">
            We delivered 50+ projects worldwide, helping service-based companies
            secure more clients
          </p>

          <ArrowUpRight className="absolute top-1/2 right-4  text-third -translate-y-1/2   w-56 h-56 md:w-66 md:h-66  xl:w-74 xl:h-74 xl:bottom-6 " />
          ...
          <div className="relative z-10">
            ...
            <div className="text-secondary font-bold text-xs uppercase tracking-widest opacity-80">
              TRUSTED BY
            </div>
            <div className="text-secondary font-bold text-xs uppercase tracking-widest opacity-80">
              CLIENTS WORLDWIDE
