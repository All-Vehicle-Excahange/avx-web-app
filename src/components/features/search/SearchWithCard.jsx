  ...
  return (
    <div className="w-full min-h-screen flex flex-col lg:flex-row bg-primary text-secondary font-sans">
      ...
      <main className="flex-1 bg-primary">
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3   2xl:grid-cols-5 gap-4 sm:gap-5 auto-rows-max sm:px-5 lg:px-6 py-4 sm:py-5 lg:py-0">
