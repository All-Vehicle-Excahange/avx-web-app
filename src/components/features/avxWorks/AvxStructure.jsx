import { UserCheck, Building2, Eye, ShieldCheck } from "lucide-react";
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-15 mt-[30]">
          <p className="text-sm tracking-[0.4em] uppercase text-third font-semibold">
            The Reecomm Difference
          </p>

          <h2 className="mt-6 text-5xl xl:text-6xl font-medium leading-tight">
            Built on verification,
            <span className="block text-fourth">not just listings</span>
          </h2>

          <p className="mt-8 text-lg leading-relaxed text-third">
            Listings on their own tell you nothing. Reecomm builds a structured
            verification layer that creates public, platform-owned trust — so
            every interaction starts with confidence, not assumption.
          </p>
        </div>
            ...
            <div className="relative z-20 flex items-center justify-center h-fit w-full lg:h-85 lg:w-80 mb-10 lg:mb-0">
              <div className="text-center px-6 lg:px-10">
                ...
                <p className="mt-4 text-2xl font-semibold leading-tight">
                  Platform-owned
                  <span className="block text-fourth">marketplace</span>
                </p>

                <p className="mt-4 text-sm leading-relaxed text-third">
                  All activity operates under Reecomm rules, visibility logic,
                  and enforcement.
                </p>
              </div>
            </div>
...
function TrustNode({ icon, title, desc, className = "" }) {
  return (
    <div
      className={`relative z-10 flex flex-col items-center text-center max-w-xs ${className}`}
    >
      <div
      ...
      <p className="mt-2 text-m leading-relaxed text-third">{desc}</p>
    </div>
  );
}
