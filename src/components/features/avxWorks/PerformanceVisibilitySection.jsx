...
import { Star, Clock, AreaChart, ShieldCheck } from "lucide-react";
          ...
          <div className="max-w-xl space-y-8">
            <div>
              <p className="text-[15px] text-third mt-4 leading-relaxed">
                Every verified consultant on Reecomm gets a professional digital
                storefront — not just a profile. It&apos;s a live business
                identity that buyers can browse, evaluate, and trust before
                making contact.
              </p>
            </div>
            ...
            <div className="space-y-3 pt-2">
              {[
                "Active inventory listings in one place",
...
function Metric({ icon, title, desc }) {
  return (
    <motion.div
      whileHover={{ y: -4 }}
      className="p-5 rounded-xl border  border-primary/10 bg-secondary/80 backdrop-blur-xl hover:border-primary/40"
    >
