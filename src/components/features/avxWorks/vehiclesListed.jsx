                ...
                {points.map((point, i) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-[9px] font-bold text-third uppercase tracking-tighter">
                        Verified
                      </span>
                ...
                <div className="relative w-72 h-72 md:w-96 md:h-96 flex items-center justify-center">
                  ...
                  <div className="relative w-60 h-60 md:w-80 md:h-80 rounded-full bg-[#080808] border border-primary/20 shadow-2xl flex flex-col items-center justify-center overflow-hidden">
                    ...
                    <div className="absolute top-12 flex flex-col items-center">
                      <p className="text-[10px] font-black text-fourth uppercase tracking-[0.4em] mb-1">
                        Standardized
                      </p>
                    ...
                    <div className="flex flex-col items-center z-20">
                      <div className="relative mb-3">
                        <ShieldCheck
                          size={64}
                          className="text-primary drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]"
                        />
                        <motion.div className="absolute -top-1 -right-1">
                          <Verified size={24} className="text-fourth" />
                        </motion.div>
                      </div>
                      <h3 className="text-4xl font-primary font-black text-primary tracking-tighter mb-1">
                        Reecomm<span className="text-fourth">.</span>
                      </h3>
                      <p className="text-[11px] font-bold text-primary/40 uppercase tracking-[0.2em]">
                        Verified Asset
                      </p>
                    </div>
                    ...
                    <div className="absolute bottom-10 flex items-center gap-6">
                      <div className="text-center">
                        <p className="text-[12px] text-primary/30 uppercase font-bold mb-0.5">
                          Confidence
                        </p>
                        <p className="text-[15px] text-primary/90 font-mono">
                          100%
                        </p>
                      </div>
                    ...
                    <span className="absolute text-[80px] font-black text-primary/2 -bottom-4 pointer-events-none select-none">
                      TRUST
                    </span>
                  </div>
                  ...
                  <div className="absolute -top-4 -right-4 bg-black border border-primary/10 px-4 py-2 rounded-2xl shadow-xl">
                    <p className="text-[9px] font-mono text-fourth">
                      ISO:9001 COMPLIANT
                    </p>
                  </div>
