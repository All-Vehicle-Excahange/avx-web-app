  ...
  if (sent) {
    return (
      <div className="rounded-2xl p-6 flex items-center gap-4 bg-fourth/5 border border-fourth/15">
        ...
        <div>
          <p className="text-sm font-bold font-primary text-primary">
            Message received
          </p>
...
export default function ArticleDetailPage() {
    ...
    return (
      <section className="relative min-h-[50vh] py-16 px-4 flex items-center justify-center">
        <div className="text-center">
          <p className="text-5xl font-black mb-4 font-primary text-third/15">
            404
          </p>
  ...
  return (
    <section className="relative min-h-screen py-16 px-4 sm:px-6 overflow-hidden">
      <div
        className={`max-w-7xl mx-auto transition-all duration-500 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-3"}`}
      >
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex items-center justify-between gap-2 text-[12px] uppercase tracking-[0.35em] font-bold mb-10 font-primary">
            <Link
              href="/avx-help-center"
              className="transition-colors duration-200 text-primary/60 hover:text-primary flex items-center gap-1"
            >
          ...
          {/* ── SUPPORT FLOW ────────────────────────── */}
          <div
            className={`overflow-hidden transition-all duration-500 ease-in-out ${supportOpen ? "max-h-100 opacity-100 mb-5" : "max-h-0 opacity-0"}`}
          >
