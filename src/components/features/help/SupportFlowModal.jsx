        ...
        >
            ...
            >
                ...
                >
                    ...
                    <button
                        onClick={onClose}
                        className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.25em] font-primary transition-colors hover:text-white"
                        style={{ color: "rgba(255,255,255,0.4)" }}
                    >
                        <X size={14} /> Close
                    </button>
                ...
                {/* Bottom return link (shown after submission) */}
                {submitted && (
                    <div
