            ...
            <div className="mt-3 pb-6 space-y-8 px-6">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-x-6 gap-y-2 text-sm">
                  <p>
                    <span className="text-third">Repainted Panels:</span> Rear
                    Left Door
                  </p>
                  <p>
              ...
              <div className="space-y-3">
                ...
                <div className="text-sm space-y-1">
                  <p>
                    <span className="text-third">Modifications Detected:</span>{" "}
                    No
                  </p>
              ...
              */}
              ...
              <div className="space-y-3">
                ...
                <div className="text-sm  grid grid-cols-1 sm:grid-cols-3 space-y-1">
                  <p>
                    <span className="text-third">Repaired & Repainted:</span>{" "}
                    Rear door
                  </p>
                  <p>
