...
function ProcessStep({ step, scrollYProgress, threshold, isLast }) {
  ...
  return (
    <div className="relative flex flex-col md:flex-row items-center justify-between w-full">
      ...
      <div
        className={`w-full md:w-[45%] flex justify-center mb-6 md:mb-0 ${isTextRight
      ...
      {/* Text Column */}
      <div
        className={`w-full md:w-[45%] text-center md:text-left ${isTextRight ? "md:order-3" : "md:order-1 md:text-right"
          }`}
      >
        <motion.div
        ...
        >
          <div
            className={`flex items-center gap-3 md:gap-4 mb-3 ${!isTextRight
          ...
          <p
            className={`text-primary opacity-70 text-base md:text-lg leading-relaxed max-w-lg ${!isTextRight ? "md:ml-auto" : "md:mr-auto"
              }`}
          >
            {step.description}
          </p>
...
export default function AvxProcess() {
  ...
  return (
    <section
      ref={containerRef}
      className="w-full relative overflow-hidden py-8 md:py-12"
    >
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 w-px h-full bg-gray-200" />

          {/* Animated Filling Line - Added hidden md:block */}
          <motion.div
            className="hidden md:block absolute left-1/2 transform -translate-x-1/2 w-0.5 bg-fourth origin-top z-10"
            style={{
              scaleY,
              height: "100%",
            }}
