          ...
          {features.map((feature, i) => {
            ...
            return (
              ...
              >
                {/* Image side */}
                <div
                  className={`relative h-56 lg:h-72 overflow-hidden m-10 ${isReversed ? "lg:order-2" : "lg:order-1"}`}
                >
                  <Image
                    src={feature.image}
                    alt={feature.title}
                ...
                {/* Content side */}
                <div
                  className={`relative flex flex-col justify-center gap-6 p-8 lg:p-12 ${isReversed ? "lg:order-1" : "lg:order-2"}`}
                >
                  {/* Top accent line */}
