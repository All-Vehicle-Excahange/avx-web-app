          ...
          <div className="lg:w-[25%] flex flex-col gap-6">
            ...
            <div className="flex flex-row items-center gap-2.5 sm:gap-3 mt-2 flex-wrap">
              ...
              <Link
                ...
                className="flex items-center gap-2 px-3.5 py-2 bg-white/5 hover:bg-white/10 border border-white/10 transition-colors rounded-lg w-fit min-w-[130px] h-10 justify-center"
              >
