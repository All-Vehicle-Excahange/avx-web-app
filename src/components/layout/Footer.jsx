...
const footerLinks = {
    ...
    consultants: [
        { label: 'Become a consultant', href: '#' },
        { label: 'Consultant pricing', href: '#' },
        { label: 'Manage my inventory', href: '#' },
        { label: 'Consultant success guide', href: '#' },
        { label: 'Partner with Reecomm', href: '#' },
    ],
    company: [
        { label: 'About us', href: '/aboutus' },
        { label: 'How inspection works', href: '/avx-works' },
        { label: 'Careers', href: '#' },
        { label: 'Blog', href: '#' },
                ...
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-8 justify-between mb-16">
                    ...
                    <div className="lg:w-[25%] flex flex-col gap-6">
                        ...
                        <p className="text-primary/60 text-[13px] leading-relaxed lg:pr-4">
                            India&apos;s trusted marketplace for used cars and two-wheelers. Verified listings, transparent prices, and real auto consultants — all in one place.
                        </p>

                        <div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row gap-3 mt-2">
                            {/* Google Play */}
                            <Link href="#" className="flex items-center gap-2 px-3 py-1.5 bg-white/5 hover:bg-white/10 border border-white/10 transition-colors rounded-lg w-fit">
                                ...
                                <div className="text-left">
                                    <div className="text-[7px] font-bold leading-none uppercase">Get it on</div>
                            ...
                            <Link href="#" className="flex items-center gap-2 px-3 py-1.5 bg-white/5 hover:bg-white/10 border border-white/10 transition-colors rounded-lg w-fit">
                                ...
                                <div className="text-left">
                                    <div className="text-[7px] font-bold leading-none uppercase">Download on the</div>
                    ...
                    <div className="lg:w-[70%] grid grid-cols-2 lg:grid-cols-4 gap-8 relative">
                        ...
                        <div className="flex flex-col gap-4">
                            <h2 className="text-[11px] font-bold uppercase tracking-[0.2em] text-white"> Buy</h2>
                        ...
                        <div className="flex flex-col gap-4 relative lg:pr-4">
                            <h2 className="text-[11px] font-bold uppercase tracking-[0.2em] text-white"> Sell</h2>
                            <ul className="flex flex-col gap-3">
                        ...
                        <div className="flex flex-col gap-4 lg:pl-4">
                            <h2 className="text-[11px] font-bold uppercase tracking-[0.2em] text-white"> Consultants</h2>
                            <ul className="flex flex-col gap-3">
