...
export default function PromoCard({
  ...
  return (
    <div
      className="relative min-w-[180px] md:min-w-[320px] h-26 md:h-[140px]
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-5">
        <span className=" text-[10px] sm:text-xs text-primary/80 mb-1">{badge}</span>
        ...
        {description && (
          <p className="text-primary/80 text-[12px] sm:text-sm mt-1">{description}</p>
        )}
      </div>
    </div>
  );
