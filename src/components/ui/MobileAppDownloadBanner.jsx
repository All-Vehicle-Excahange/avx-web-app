    ...
    <div className="relative flex w-full flex-col bg-[#007AFF] p-4 md:hidden shadow-lg">
      ...
      <div className="mt-3 flex flex-row gap-2">
        <button
          ...
          className="flex-1 flex items-center justify-center px-2 py-1.5 bg-secondary text-primary hover:bg-primary hover:text-secondary transition-all duration-300 rounded-lg cursor-pointer"
        >
