    ...
    <>
      ...
      >
        <motion.button
          ...
          className="absolute right-4  bottom-12 sm:right-6 lg:bottom-10 bg-fourth text-primary p-3 sm:p-4 rounded-full shadow-[0_10px_30px_rgba(0,0,0,0.5)] cursor-grab active:cursor-grabbing hover:bg-fourth/90 border border-primary/20 flex flex-col items-center justify-center gap-1 w-14 h-14 transition-colors pointer-events-auto"
          whileTap={{ scale: 0.95 }}
