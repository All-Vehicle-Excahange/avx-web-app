...
function RejectInqPopup({ onClose, onConfirm, loading = false }) {
  const [reason, setReason] = useState("");
  const [comment, setComment] = useState("");
  const [isClosing, setIsClosing] = useState(false);

  const rejectReasons = [
    "Vehicle already sold / unavailable",
    "Inquirer profile seems suspicious / fake",
    "Asking price negotiation too low",
    "Other",
  ];
    ...
    >
      ...
      >
        <div className="flex justify-between items-center">
          <h2 className="text-lg font-semibold text-primary">Reject Inquiry</h2>
        ...
        <div className="space-y-2">
          <p className="text-sm text-third font-medium">
            Why are you rejecting this inquiry?
          </p>
