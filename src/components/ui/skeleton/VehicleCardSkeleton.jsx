...
export default function VehicleCardSkeleton() {
  return (
    <div className="group/card relative flex flex-row md:flex-col rounded-2xl overflow-hidden text-primary w-full border-2 border-third/20 h-full md:min-h-[420px]">
