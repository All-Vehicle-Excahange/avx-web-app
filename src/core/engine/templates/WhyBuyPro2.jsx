...
export default function WhyBuyPro2({ data: rawData, isEditing, onUpdate }) {
    ...
    const handleStoryBlur = async () => {
        try {
            ...
            if (data.storyTemplate1?.id) formData.append("storyTemplateId1", data.storyTemplate1.id);
            if (data.storyTemplate2?.id) formData.append("storyTemplateId2", data.storyTemplate2.id);
            if (data.storyTemplate3?.id) formData.append("storyTemplateId3", data.storyTemplate3.id);
            if (data.storyTemplate4?.id) formData.append("storyTemplateId4", data.storyTemplate4.id);
    ...
    const handleVehicleSelectionBlur = async () => {
        try {
            ...
            if (data.vehicleSelectionTemplate1?.id) formData.append("vehicleSelectionTemplateId1", data.vehicleSelectionTemplate1.id);
            if (data.vehicleSelectionTemplate2?.id) formData.append("vehicleSelectionTemplateId2", data.vehicleSelectionTemplate2.id);
            if (data.vehicleSelectionTemplate3?.id) formData.append("vehicleSelectionTemplateId3", data.vehicleSelectionTemplate3.id);
    ...
    const handleProcessBlur = async () => {
        try {
            ...
            if (data.processTemplate1?.id) formData.append("processTemplateId1", data.processTemplate1.id);
            if (data.processTemplate2?.id) formData.append("processTemplateId2", data.processTemplate2.id);
            if (data.processTemplate3?.id) formData.append("processTemplateId3", data.processTemplate3.id);
            if (data.processTemplate4?.id) formData.append("processTemplateId4", data.processTemplate4.id);
    ...
    const handleInspectionBlur = async () => {
        try {
            ...
            if (data.inspectionTemplate1?.id) formData.append("inspectionTemplateId1", data.inspectionTemplate1.id);
            if (data.inspectionTemplate2?.id) formData.append("inspectionTemplateId2", data.inspectionTemplate2.id);
            if (data.inspectionTemplate3?.id) formData.append("inspectionTemplateId3", data.inspectionTemplate3.id);
            if (data.inspectionTemplate4?.id) formData.append("inspectionTemplateId4", data.inspectionTemplate4.id);
    ...
    const handleCustomerCommitmentBlur = async () => {
        try {
            ...
            if (data.customerCommitmentTemplate1?.id) formData.append("customerCommitmentTemplateId1", data.customerCommitmentTemplate1.id);
            if (data.customerCommitmentTemplate2?.id) formData.append("customerCommitmentTemplateId2", data.customerCommitmentTemplate2.id);
            if (data.customerCommitmentTemplate3?.id) formData.append("customerCommitmentTemplateId3", data.customerCommitmentTemplate3.id);
            ...
            <div className="w-full max-w-[1480px] mx-auto p-8 rounded-xl space-y-10">
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="h-40 relative col-span-2">
                                    <ImageUploader label="Image 1" src={data.storyTemplate1?.imageUrl} fieldKey="storyImg1" imageType="CONSULTANT_STORY" onChange={({ imageUrl, id }) => { updateField("storyTemplate1", { ...data.storyTemplate1, imageUrl, id: id ?? data.storyTemplate1?.id }); setTimeout(handleStoryBlur, 100); }} />
                                </div>
                                <div className="h-40 relative">
                                    <ImageUploader label="Image 2" src={data.storyTemplate2?.imageUrl} fieldKey="storyImg2" imageType="CONSULTANT_STORY" onChange={({ imageUrl, id }) => { updateField("storyTemplate2", { ...data.storyTemplate2, imageUrl, id: id ?? data.storyTemplate2?.id }); setTimeout(handleStoryBlur, 100); }} />
                                </div>

                                <div className="h-40 relative">
                                    <ImageUploader label="Image 3" src={data.storyTemplate3?.imageUrl} fieldKey="storyImg3" imageType="CONSULTANT_STORY" onChange={({ imageUrl, id }) => { updateField("storyTemplate3", { ...data.storyTemplate3, imageUrl, id: id ?? data.storyTemplate3?.id }); setTimeout(handleStoryBlur, 100); }} />
                                </div>
                                <div className="h-40 relative">
                                    <ImageUploader label="Image 4" src={data.storyTemplate4?.imageUrl} fieldKey="storyImg4" imageType="CONSULTANT_STORY" onChange={({ imageUrl, id }) => { updateField("storyTemplate4", { ...data.storyTemplate4, imageUrl, id: id ?? data.storyTemplate4?.id }); setTimeout(handleStoryBlur, 100); }} />
                                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="h-40 relative">
                                    <ImageUploader label="Image 1" src={data.vehicleSelectionTemplate1?.imageUrl} fieldKey="selImg1" imageType="VEHICLE_SELECTION" onChange={({ imageUrl, id }) => { updateField("vehicleSelectionTemplate1", { ...data.vehicleSelectionTemplate1, imageUrl, id: id ?? data.vehicleSelectionTemplate1?.id }); setTimeout(handleVehicleSelectionBlur, 100); }} />
                                </div>
                                <div className="h-40 relative">
                                    <ImageUploader label="Image 2" src={data.vehicleSelectionTemplate2?.imageUrl} fieldKey="selImg2" imageType="VEHICLE_SELECTION" onChange={({ imageUrl, id }) => { updateField("vehicleSelectionTemplate2", { ...data.vehicleSelectionTemplate2, imageUrl, id: id ?? data.vehicleSelectionTemplate2?.id }); setTimeout(handleVehicleSelectionBlur, 100); }} />
                                </div>
                                <div className="h-40 relative col-span-2">
                                    <ImageUploader label="Image 3" src={data.vehicleSelectionTemplate3?.imageUrl} fieldKey="selImg3" imageType="VEHICLE_SELECTION" onChange={({ imageUrl, id }) => { updateField("vehicleSelectionTemplate3", { ...data.vehicleSelectionTemplate3, imageUrl, id: id ?? data.vehicleSelectionTemplate3?.id }); setTimeout(handleVehicleSelectionBlur, 100); }} />
                                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="h-40 relative">
                                    <ImageUploader label="Image 1" src={data.processTemplate1?.imageUrl} fieldKey="procImg1" imageType="PROCESS" onChange={({ imageUrl, id }) => { updateField("processTemplate1", { ...data.processTemplate1, imageUrl, id: id ?? data.processTemplate1?.id }); setTimeout(handleProcessBlur, 100); }} />
                                </div>
                                <div className="h-40 relative">
                                    <ImageUploader label="Image 2" src={data.processTemplate2?.imageUrl} fieldKey="procImg2" imageType="PROCESS" onChange={({ imageUrl, id }) => { updateField("processTemplate2", { ...data.processTemplate2, imageUrl, id: id ?? data.processTemplate2?.id }); setTimeout(handleProcessBlur, 100); }} />
                                </div>
                                <div className="h-40 relative">
                                    <ImageUploader label="Image 3" src={data.processTemplate3?.imageUrl} fieldKey="procImg3" imageType="PROCESS" onChange={({ imageUrl, id }) => { updateField("processTemplate3", { ...data.processTemplate3, imageUrl, id: id ?? data.processTemplate3?.id }); setTimeout(handleProcessBlur, 100); }} />
                                </div>
                                <div className="h-40 relative">
                                    <ImageUploader label="Image 4" src={data.processTemplate4?.imageUrl} fieldKey="procImg4" imageType="PROCESS" onChange={({ imageUrl, id }) => { updateField("processTemplate4", { ...data.processTemplate4, imageUrl, id: id ?? data.processTemplate4?.id }); setTimeout(handleProcessBlur, 100); }} />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="h-40 relative">
                                    <ImageUploader label="Image 1" src={data.inspectionTemplate1?.imageUrl} fieldKey="inspImg1" imageType="INSPECTION_PROCESS" onChange={({ imageUrl, id }) => { updateField("inspectionTemplate1", { ...data.inspectionTemplate1, imageUrl, id: id ?? data.inspectionTemplate1?.id }); setTimeout(handleInspectionBlur, 100); }} />
                                </div>
                                <div className="h-40 relative">
                                    <ImageUploader label="Image 2" src={data.inspectionTemplate2?.imageUrl} fieldKey="inspImg2" imageType="INSPECTION_PROCESS" onChange={({ imageUrl, id }) => { updateField("inspectionTemplate2", { ...data.inspectionTemplate2, imageUrl, id: id ?? data.inspectionTemplate2?.id }); setTimeout(handleInspectionBlur, 100); }} />
                                </div>
                                <div className="h-40 relative">
                                    <ImageUploader label="Image 3" src={data.inspectionTemplate3?.imageUrl} fieldKey="inspImg3" imageType="INSPECTION_PROCESS" onChange={({ imageUrl, id }) => { updateField("inspectionTemplate3", { ...data.inspectionTemplate3, imageUrl, id: id ?? data.inspectionTemplate3?.id }); setTimeout(handleInspectionBlur, 100); }} />
                                </div>
                                <div className="h-40 relative">
                                    <ImageUploader label="Image 4" src={data.inspectionTemplate4?.imageUrl} fieldKey="inspImg4" imageType="INSPECTION_PROCESS" onChange={({ imageUrl, id }) => { updateField("inspectionTemplate4", { ...data.inspectionTemplate4, imageUrl, id: id ?? data.inspectionTemplate4?.id }); setTimeout(handleInspectionBlur, 100); }} />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            <p className="text-sm font-semibold text-primary">Commitment Images</p>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="h-40 relative">
                                    <ImageUploader label="Image 1" src={data.customerCommitmentTemplate1?.imageUrl} fieldKey="commImg1" imageType="CUSTOMER_COMMITMENT" onChange={({ imageUrl, id }) => { updateField("customerCommitmentTemplate1", { ...data.customerCommitmentTemplate1, imageUrl, id: id ?? data.customerCommitmentTemplate1?.id }); setTimeout(handleCustomerCommitmentBlur, 100); }} />
                                </div>
                                <div className="h-40 relative">
                                    <ImageUploader label="Image 2" src={data.customerCommitmentTemplate2?.imageUrl} fieldKey="commImg2" imageType="CUSTOMER_COMMITMENT" onChange={({ imageUrl, id }) => { updateField("customerCommitmentTemplate2", { ...data.customerCommitmentTemplate2, imageUrl, id: id ?? data.customerCommitmentTemplate2?.id }); setTimeout(handleCustomerCommitmentBlur, 100); }} />
                                </div>
                                <div className="h-40 relative col-span-2">
                                    <ImageUploader label="Image 3" src={data.customerCommitmentTemplate3?.imageUrl} fieldKey="commImg3" imageType="CUSTOMER_COMMITMENT" onChange={({ imageUrl, id }) => { updateField("customerCommitmentTemplate3", { ...data.customerCommitmentTemplate3, imageUrl, id: id ?? data.customerCommitmentTemplate3?.id }); setTimeout(handleCustomerCommitmentBlur, 100); }} />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="h-40 relative">
                            <ImageUploader label="Gallery Image 1" src={data.galleryTemplate1?.imageUrl} fieldKey="galImg1" imageType="GALLERY" onChange={({ imageUrl, id }) => { updateField("galleryTemplate1", { ...data.galleryTemplate1, imageUrl, id: id ?? data.galleryTemplate1?.id }); setTimeout(handleGalleryBlur, 100); }} />
                        </div>
                        <div className="h-40 relative">
                            <ImageUploader label="Gallery Image 2" src={data.galleryTemplate2?.imageUrl} fieldKey="galImg2" imageType="GALLERY" onChange={({ imageUrl, id }) => { updateField("galleryTemplate2", { ...data.galleryTemplate2, imageUrl, id: id ?? data.galleryTemplate2?.id }); setTimeout(handleGalleryBlur, 100); }} />
                        </div>
                        <div className="h-40 relative">
                            <ImageUploader label="Gallery Image 3" src={data.galleryTemplate3?.imageUrl} fieldKey="galImg3" imageType="GALLERY" onChange={({ imageUrl, id }) => { updateField("galleryTemplate3", { ...data.galleryTemplate3, imageUrl, id: id ?? data.galleryTemplate3?.id }); setTimeout(handleGalleryBlur, 100); }} />
                        </div>
                        <div className="h-40 relative">
                            <ImageUploader label="Gallery Image 4" src={data.galleryTemplate4?.imageUrl} fieldKey="galImg4" imageType="GALLERY" onChange={({ imageUrl, id }) => { updateField("galleryTemplate4", { ...data.galleryTemplate4, imageUrl, id: id ?? data.galleryTemplate4?.id }); setTimeout(handleGalleryBlur, 100); }} />
                        </div>
                        <div className="h-40 relative">
                            <ImageUploader label="Gallery Image 5" src={data.galleryTemplate5?.imageUrl} fieldKey="galImg5" imageType="GALLERY" onChange={({ imageUrl, id }) => { updateField("galleryTemplate5", { ...data.galleryTemplate5, imageUrl, id: id ?? data.galleryTemplate5?.id }); setTimeout(handleGalleryBlur, 100); }} />
                        </div>
