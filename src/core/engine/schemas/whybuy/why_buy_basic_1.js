...
Our goal is to maintain a diverse vehicle inventory and provide accurate information so buyers can make confident decisions when purchasing their next vehicle.`,
    ...
    rules: {
      ...
      whyBuyHeroDescription: { min: 50, max: 1000 },
      storyTitle: { min: 10, max: 40 },
      storyDescription: { min: 50, max: 1000 },
      vehicleSelectionTitle: { min: 10, max: 40 },
      vehicleSelectionDescription: { min: 50, max: 1000 },
      processTitle: { min: 10, max: 40 },
      processDescription: { min: 50, max: 800 },
      inspectionTitle: { min: 10, max: 40 },
      inspectionText: { min: 50, max: 400 },
      customerCommitmentTitle: { min: 10, max: 40 },
      customerCommitmentDescription: { min: 50, max: 1000 },
