export const WHY_BUY_PREMIUM_3 = [
  {
    id: "why_buy_premium_3",
    type: "why_buy_theme_premium_3",
    data: {
      /* ───────── HERO ───────── */
      whyBuyHeroTitle: "Why Choose Adarsh Auto Consultants",
      whyBuyHeroDescription: `<p>Buyers trust Adarsh Auto Consultants for transparent communication, reliable vehicle options, and a smooth buying experience.</p>`,
      whyBuyHeroTemplate1: { id: 1, imageUrl: "/store-front-template2.mp4" },
      whyBuyHeroTemplate2: {
        id: 2,
        imageUrl:
      ...
      storyDescription: `<p>For over 12 years, Adarsh Auto Consultants has been helping buyers discover reliable vehicles across Gujarat.</p><p>Our goal is to maintain a diverse vehicle inventory and provide accurate information so buyers can make confident decisions when purchasing their next vehicle.</p>`,
      storyTemplate1: {
        id: 1,
        imageUrl:
      ...
      vehicleSelectionDescription: `<p>Every vehicle listed through our storefront goes through a basic internal evaluation before being presented to buyers. This helps ensure that vehicles listed are suitable for serious buyers and provides a smoother vehicle buying experience.</p>`,
      ...
      processDescription: `<p>Buying a vehicle through our storefront is designed to be simple, transparent, and convenient for buyers.</p>`,
      processTemplate1: {
        id: 1,
        imageUrl:
      ...
      processSteps: [
        {
          ...
          description: `<p>Browse our inventory and shortlist vehicles that match your requirements.</p>`,
        ...
        },
        {
          ...
          description: `<p>Once satisfied with the vehicle details and inspection, finalize the purchase directly with the consultant.</p>`,
      ...
      customerCommitmentDescription: `<p>Our goal is to maintain transparent communication and assist buyers throughout the vehicle discovery and purchase process. We aim to provide honest guidance and reliable information for every buyer.</p>`,
    ...
    rules: {
      ...
      whyBuyHeroTemplate2: {},
      whyBuyHeroTemplate3: {},
      storyTitle: { min: 10, max: 40 },
      storyDescription: { min: 50, max: 800 },
      storyTemplate1: {},
      storyTemplate2: {},
      storyTemplate3: {},
      vehicleSelectionTitle: { min: 10, max: 40 },
      vehicleSelectionDescription: { min: 50, max: 600 },
      vehicleSelectionTemplate1: {},
      vehicleSelectionTemplate2: {},
      processTitle: { min: 10, max: 40 },
      processDescription: { min: 50, max: 600 },
      processTemplate1: {},
      processTemplate2: {},
      processTemplate3: {},
      processTemplate4: {},
      inspectionTitle: { min: 10, max: 40 },
      inspectionText: { min: 50, max: 600 },
      inspectionTemplate1: {},
      inspectionTemplate2: {},
      inspectionTemplate3: {},
      customerCommitmentTitle: { min: 10, max: 40 },
      customerCommitmentDescription: { min: 50, max: 600 },
      customerCommitmentTemplate1: {},
      customerCommitmentTemplate2: {},
      customerCommitmentTemplate3: {},
      customerCommitmentTemplate4: {},
