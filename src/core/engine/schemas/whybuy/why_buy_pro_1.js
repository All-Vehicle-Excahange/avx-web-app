export const WHY_BUY_PRO_1 = [
    {
        id: "why_buy_pro_1",
        type: "why_buy_theme_pro_1",
        data: {
        ...
        rules: {
            ...
            whyBuyHeroDescription: { min: 50, max: 500 },
            whyBuyHeroTemplate1: {},
            whyBuyHeroTemplate2: {},
            whyBuyHeroTemplate3: {},
            storyTitle: { min: 10, max: 40 },
            storyDescription: { min: 50, max: 400 },
            storyTemplate1: {},
            storyTemplate2: {},
            storyTemplate3: {},
            storyTemplate4: {},
            vehicleSelectionTitle: { min: 10, max: 40 },
            vehicleSelectionDescription: { min: 50, max: 400 },
            vehicleSelectionTemplate1: {},
            vehicleSelectionTemplate2: {},
            processTitle: { min: 10, max: 40 },
            processDescription: { min: 50, max: 400 },
            processTemplate1: {},
            processTemplate2: {},
            processTemplate3: {},
            processTemplate4: {},
            inspectionTitle: { min: 10, max: 40 },
            inspectionText: { min: 50, max: 500 },
            inspectionTemplate1: {},
            inspectionTemplate2: {},
            inspectionTemplate3: {},
            inspectionTemplate4: {},
            customerCommitmentTitle: { min: 10, max: 40 },
            customerCommitmentDescription: { min: 50, max: 500 },
