export const WHY_BUY_PREMIUM_2 = [
  {
    id: "why_buy_premium_2",
    type: "why_buy_theme_premium_2",
    data: {
      /* ───────── HERO ───────── */
    ...
    rules: {
      ...
      whyBuyHeroDescription: { min: 50, max: 600 },
      whyBuyHeroTemplate1: {},
      whyBuyHeroTemplate2: {},
      whyBuyHeroTemplate3: {},
      storyTitle: { min: 10, max: 40 },
      storyDescription: { min: 50, max: 600 },
      storyTemplate1: {},
      storyTemplate2: {},
      storyTemplate3: {},
      ...
      processDescription: { min: 50, max: 800 },
      processTemplate1: {},
      processTemplate2: {},
      processTemplate3: {},
      processTemplate4: {},
      inspectionTitle: { min: 10, max: 40 },
      inspectionText: { min: 50, max: 800 },
      inspectionTemplate1: {},
      inspectionTemplate2: {},
      inspectionTemplate3: {},
      customerCommitmentTitle: { min: 10, max: 40 },
      customerCommitmentDescription: { min: 50, max: 800 },
      customerCommitmentTemplate1: {},
      customerCommitmentTemplate2: {},
      customerCommitmentTemplate3: {},
      customerCommitmentTemplate4: {},
